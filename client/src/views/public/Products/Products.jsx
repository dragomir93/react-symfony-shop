...
import {
  Alert, Avatar, Box, ButtonGroup, Container,
  Dialog,
  DialogActions,
  DialogContent,
  DialogContentText,
...
import {
  generatePath, Link, useLocation, useNavigate,
...
function Products() {
  ...
  const showProduct = (productId) => {
    navigate(generatePath(generatePath(publicRouteCodes.PRODUCTS_SHOW, { id: productId })));
  };

  const updateProduct = (productId) => {
    navigate(generatePath(generatePath(publicRouteCodes.PRODUCTS_EDIT, { id: productId })));
  };
  ...
  return (
    <div className={classes.root}>
      ...
      && (
      <Stack sx={{
        width: '13%', marginBottom: '10px', marginLeft: '10px', position: 'fixed', bottom: 0,
      }}
      >
